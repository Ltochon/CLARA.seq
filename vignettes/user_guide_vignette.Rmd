---
title: "User Guide"
author: "Louis Tochon and Matthias Studer"
...
With the package *TraMineR* it is possible to draw a graph with the sequence distribution. To do this, the function *seqdplot* will be use as follow (this example use the resulting clustering *my_cluster" from CLARA but this graph works for each clustering algorithm) :
